# Generated by Powerlevel10k configuration wizard on 2021-03-03 at 14:43 MSK.
...
# sharp heads, sharp tails, 2 lines, solid, left frame, sparse, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%244F'  #'%244F\uE0B1'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%244F'  #'%244F\uE0B3'
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='λ'  #'❯' 'λ'
