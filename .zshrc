...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(context ssh anaconda root_indicator dir dir_writable vcs)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(background_jobs status command_execution_time load time)

# prompt
POWERLEVEL9K_PROMPT_ON_NEWLINE=true
# POWERLEVEL9K_RPROMPT_ON_NEWLINE=true
POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX="%F{033}\u256D\u2500%f"
# POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX="%F{033}\u2570\uf460%f "
POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX="%F{033}\u2570\u03BB%f "
...
POWERLEVEL9K_CONTEXT_SUDO_BACKGROUND='black'  # 247
# ssh
#
# root_indicator
#
...
typeset POWERLEVEL9K_DIR_{HOME,HOME_SUBFOLDER,DEFAULT,ETC}_BACKGROUND='033'
# dir_writable
...
POWERLEVEL9K_STATUS_ERROR_FOREGROUND='220'
POWERLEVEL9K_STATUS_ERROR_BACKGROUND='red'
# command_execution_time
POWERLEVEL9K_COMMAND_EXECUTION_TIME_THRESHOLD=1
POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='250'
POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=$DARK
# load
POWERLEVEL9K_LOAD_NORMAL_FOREGROUND='250'  # 034
POWERLEVEL9K_LOAD_WARNING_FOREGROUND='220'
POWERLEVEL9K_LOAD_CRITICAL_FOREGROUND='196'
typeset POWERLEVEL9K_LOAD_{NORMAL,WARNING,CRITICAL}_BACKGROUND=$DARK
# time
POWERLEVEL9K_TIME_FORMAT="%D{%H:%M}"
POWERLEVEL9K_TIME_FOREGROUND='250'
POWERLEVEL9K_TIME_BACKGROUND=$DARK
