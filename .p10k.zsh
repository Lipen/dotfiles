# Generated by Powerlevel10k configuration wizard on 2020-05-29 at 20:39 MSK.
...
() {
  ...
  # Dir separator
  # typeset -g POWERLEVEL9K_DIR_PATH_SEPARATOR=" %F{248}"$'\uE0B1'"%f "
  typeset -g POWERLEVEL9K_DIR_PATH_SEPARATOR="%f "$'\uE0B1'" "
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=220
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND=228
  # Custom icon.
  ...
  #####################################[ swap: used swap ]######################################
  # Swap color.
  typeset -g POWERLEVEL9K_SWAP_FOREGROUND=250
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND='red3a'
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=75
  ...
  ####################[ java_version: java version (https://www.java.com/) ]####################
  # Java version color.
  typeset -g POWERLEVEL9K_JAVA_VERSION_FOREGROUND=39
